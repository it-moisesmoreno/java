package com.mycompany.java.fundamentals.datastructures.tree;
...
class Tree {
    ...
    // Function to print the leaf node
    public static void printLeafNodes(int Root, Vector<Vector<Integer>> adj) {

        // Leaf node have only one edge and are not the root
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Size of adj: " + adj.size());
        System.out.println("Size of adj.get(0): " + adj.get(0).size());

        // Creating the tree
        adj.get(1).add(2);
        adj.get(2).add(1);
        System.out.println("Size of adj: " + adj.size());
        System.out.println("Size of adj.get(1): " + adj.get(1).size());
        System.out.println("Size of adj.get(2): " + adj.get(2).size());
