...
This project is licensed under the MIT License. See the [LICENSE](https://github.com/it-moisesmoreno/java/tree/main?tab=MIT-1-ov-file) file for more details.
